...
def app_specific_action(webdriver, datasets):
    ...
    if datasets['custom_pages']:
        app_specific_page_id = datasets['393565'] #pageid of rate page 393569
        rate_page_id = datasets['393569']
        rate_search_page_id = datasets['393567'] #pageid of rate search
        rate_blog_id = datasets['393575'] #blogid of rate macro
        rate_search_blog_id = datasets['393579'] #blogid of rate search macro
